# Objetivo 
Crear un contenedor apptainer que contenga influxdb y snmp para consultar la temperatura de un cuarto frio periódicamente y guardarlo en una base de datos basada en tiempo.
